...
distributions, sampling methods are of great use. Monte Carlo (\abbr{MC})
sampling, quasi-\abbr{MC} sampling, and Latin hypercube sampling are examples of
...
behavior of the system. Consider, for instance, the classical \abbr{MC}

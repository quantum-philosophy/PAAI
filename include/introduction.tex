...
provides an overview of the prior work. In \sref{present-work}, the contribution
of the paper is summarized. The preliminaries are given in \sref{preliminaries}.
The addressed problem is formulated in \sref{problem}, and our solution is
outlined in \sref{solution}. An illustrative example is considered in
\sref{example}. The framework is presented in \sref{modeling},

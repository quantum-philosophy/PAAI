...
academia and in terms of industrial breakthroughs. The success of \abbr{MC}
...
approach (the law of large numbers). The major problem with \abbr{MC} sampling,
...
that matters to the problem at hand---\abbr{MC} methods are rendered as slow and
often infeasible.

...
\sref{interpolation}. \updated{However, before we proceed to interpolation, we
first need to elaborate on the modeling of uncertain parameters and metrics of
interest.}

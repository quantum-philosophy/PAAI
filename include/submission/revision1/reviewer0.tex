...
\begin{actions}
  \action{The language has been made more straightforward throughout the paper.}
  \action{The illustrative example has been moved higher up, and the
  corresponding figure has been referenced better from the subsequent sections.}
\end{actions}
\end{authors}
...
\begin{actions}
  ...
  \action{The infrastructure for coupling the proposed framework with an
  arbitrary simulator has been included in the publicly accessible supplementary
  materials.}
\end{actions}
\end{authors}

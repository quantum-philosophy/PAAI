...
execution time of \token{T3} is chosen to lie in the range of the possible
values of the execution time of \token{T2}; in this case, the impact of $\u_1$
on $\g$ gets cut off.
...
true density of $\g$; its calculation is explained in \sref{experimentation}. It

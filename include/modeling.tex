...
introduce a number of models and a number of metrics $\g$ in order to give the
reader a better intuition about the utility of the framework. These models and
metrics also give us concrete problems to work with in the section on
experimental results, \sref{experimentation}.} It should be well understood that
the essence of $\g$ is problem specific. \updated{Consequently, the exact
formulation of $\g$ is left to the designer's discretion.}

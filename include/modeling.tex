...
denoted by $\transformation$ in \fref{example}. The rest of the subsections,
\sref{time}--\ref{sec:temperature}, serve a strictly illustrative purpose.
They exemplify the leftmost box in \fref{example} in order to give the reader a
...
the section on experimental results, \sref{experimentation}.

...
utilized (see \sref{collocation-nodes}), and its \token{Compute} method converts
...
utilized (see \sref{basis-functions}), and its \token{Compute} method evaluates
a single basis function at a single point.

...
two sums into one in \eref{approximation}. This is achieved by storing a level
...
\]
where $\lor$ and $\ll$ are the bitwise \abbr{OR} and logical left shift,
...
It can be seen in \eref{approximation} that an interpolant is entirely

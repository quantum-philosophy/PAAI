...
Lastly, we need to impose one additional property in order to obtain a
hierarchical version of \eref{smolyak-incremental}. Namely, we require the
...
\end{equation}
The condition in \eref{tensor-exactness} can be achieved by an appropriate

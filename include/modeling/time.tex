...
\eref{end-to-end-delay} depends on $\vu$ and constitutes a potential quantity of
interest $\g$. Note that this $\g$ is nondifferentiable in general as the $\max$
and $\min$ functions are such. Hence, $\g$ is nonsmooth, which renders \up{PC}
expansions and similar techniques inadequate for this problem, as illustrated in
\sref{introduction}.

\begin{remark} \rlab{nonsmoothness}
